...
if(NOT TARGET libp11)
    add_library(libp11 SHARED IMPORTED)
endif()
add_library(libp11::libp11 ALIAS libp11)

message(STATUS "libp11::libp11::INTERFACE_INCLUDE_DIRECTORIES ${LIBP11_INCLUDE_DIR}")
message(STATUS "libp11::libp11::IMPORTED_LOCATION ${LIBP11_LIBRARY}")
message(STATUS "libp11::libp11::INTERFACE_LINK_LIBRARIES ${LIBP11_LIBRARIES}")
